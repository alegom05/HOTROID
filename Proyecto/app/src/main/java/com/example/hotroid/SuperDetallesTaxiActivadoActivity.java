...
public class SuperDetallesTaxiActivadoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.super_detalles_taxi_activado);
        ...
        TextView tvPlacaVehiculoDetalle = findViewById(R.id.tvPlacaVehiculoDetalle); // Nuevo
        ImageView fotoPrincipal = findViewById(R.id.fotoPrincipal);
        ImageView fotoVehiculo = findViewById(R.id.fotoVehiculo); // Nuevo
        ...
        if (taxiDataFull != null && taxiDataFull.length >= 11) { // Asegura que el array tenga todos los datos
            ...
            // Asignar imágenes (puedes tener lógica más avanzada si las imágenes varían)
            if (fotoPrincipal != null) fotoPrincipal.setImageResource(R.drawable.foto_admin); // Placeholder
            if (fotoVehiculo != null) fotoVehiculo.setImageResource(R.drawable.carrito); // Placeholder
        } else {
        ...
        // Click listener para el botón Desactivar
        if (btnDesactivar != null) {
            btnDesactivar.setOnClickListener(v -> {
                ...
                // Pasar el nombre del taxista para la notificación en la lista
        ...
        if (bottomNavigationView != null) {
            bottomNavigationView.setOnNavigationItemSelectedListener(item -> {
                ...
                if (itemId == R.id.nav_hoteles) {
                    startActivity(new Intent(SuperDetallesTaxiActivadoActivity.this, SuperActivity.class));
                    finish();
                    return true;
        ...
        if (cardPerfil != null) {
            cardPerfil.setOnClickListener(v -> {
                startActivity(new Intent(SuperDetallesTaxiActivadoActivity.this, SuperCuentaActivity.class));
            });
        }
    }
}