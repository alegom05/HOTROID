...
public class SuperDetallesClienteDesactivadoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (clientDataFull != null && clientDataFull.length >= 9) {
        ...
        if (bottomNavigationView != null) {
            bottomNavigationView.setOnNavigationItemSelectedListener(item -> {
                ...
                if (itemId == R.id.nav_hoteles) {
                    startActivity(new Intent(SuperDetallesClienteDesactivadoActivity.this, SuperActivity.class));
                    finish();
                    return true;
                } else if (itemId == R.id.nav_usuarios) {
                    startActivity(new Intent(SuperDetallesClienteDesactivadoActivity.this, SuperUsuariosActivity.class));
                    finish();
                    return true;
                } else if (itemId == R.id.nav_eventos) {
                    startActivity(new Intent(SuperDetallesClienteDesactivadoActivity.this, SuperEventosActivity.class));
                    finish();
                    return true;
                }
                return false;
        ...
        if (cardPerfil != null) {
            cardPerfil.setOnClickListener(v -> {
                startActivity(new Intent(SuperDetallesClienteDesactivadoActivity.this, SuperCuentaActivity.class));
            });
        }
    }
}