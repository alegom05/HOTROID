    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(item -> {
            if (item.getItemId() == R.id.nav_hoteles) {
                Intent intentInicio = new Intent(SuperDetallesTaxiDesactivadoActivity.this, SuperActivity.class);
                ...
                Intent intentAlertas = new Intent(SuperDetallesTaxiDesactivadoActivity.this, SuperEventosActivity.class);
        ...
        btnActivar.setOnClickListener(v -> {
            Intent intent = new Intent(SuperDetallesTaxiDesactivadoActivity.this, SuperListaTaxisActivity.class);
            startActivity(intent);
        });

        CardView cardSuper2 = findViewById(R.id.cardPerfil);
        cardSuper2.setOnClickListener(v -> {
            Intent intent = new Intent(SuperDetallesTaxiDesactivadoActivity.this, SuperCuentaActivity.class);
            startActivity(intent);
        });
    }
}
