...
public class SuperDetallesTaxiPendienteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Click listener para el botón Aprobar
        if (btnAprobar != null) {
            btnAprobar.setOnClickListener(v -> {
                Intent resultIntent = new Intent();
                resultIntent.putExtra("action", "aprobado");
        ...
        // Click listener para el botón Rechazar
        if (btnRechazar != null) {
            btnRechazar.setOnClickListener(v -> {
                Intent resultIntent = new Intent();
                resultIntent.putExtra("action", "rechazado");
                resultIntent.putExtra("taxi_position", taxiPosition);
                if (taxiDataFull != null) {
                    resultIntent.putExtra("taxi_name", taxiDataFull[1] + " " + taxiDataFull[2]);
                }
        ...
        if (bottomNavigationView != null) {
            bottomNavigationView.setOnNavigationItemSelectedListener(item -> {
                ...
                if (itemId == R.id.nav_hoteles) {
                    startActivity(new Intent(SuperDetallesTaxiPendienteActivity.this, SuperActivity.class));
                    finish();
                    return true;
                    ...
                    startActivity(new Intent(SuperDetallesTaxiPendienteActivity.this, SuperEventosActivity.class));
                    finish();
                    return true;
                }
                return false;
        ...
        if (cardPerfil != null) {
            cardPerfil.setOnClickListener(v -> {
                startActivity(new Intent(SuperDetallesTaxiPendienteActivity.this, SuperCuentaActivity.class));
            });
        }
    }
}